...
class TestAuthenticationService:
    ...
    def auth_service(self):
        ...
        from engine.shared.auth import AuthenticationService
    ...
    async def test_tiered_auth_function_key_priority(self, auth_service):
        ...
        from engine.shared.auth import FunctionKeyPrincipal
    ...
    async def test_tiered_auth_easy_auth_fallback(self, auth_service):
        ...
        from engine.shared.auth import UserPrincipal
    ...
    def test_get_current_principal_with_principal(self):
        ...
        from engine.shared.auth import get_current_principal, FunctionKeyPrincipal
    ...
    def test_get_current_principal_no_principal(self):
        ...
        from engine.shared.auth import get_current_principal
    ...
    def test_is_function_key_auth(self):
        ...
        from engine.shared.auth import is_function_key_auth, FunctionKeyPrincipal
    ...
    def test_is_user_auth(self):
        ...
        from engine.shared.auth import is_user_auth, UserPrincipal
    ...
    async def test_require_auth_decorator_success(self):
        ...
        from engine.shared.auth import require_auth, FunctionKeyPrincipal
    ...
    async def test_require_auth_decorator_auth_failure(self):
        ...
        from engine.shared.auth import require_auth, AuthenticationError
