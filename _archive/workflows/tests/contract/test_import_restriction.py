...
class TestImportRestrictionContract:
    ...
    def test_import_restrictor_module_exists(self):
        ...
        try:
            from engine.shared import import_restrictor
    ...
    def test_workspace_cannot_import_engine_storage(self):
        """Contract: Workspace code must not import engine.shared.storage"""
        from engine.shared.import_restrictor import install_import_restrictions
        import tempfile
...
class TestImportRestrictionBehavior:
    ...
    def test_engine_code_can_import_freely(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                from engine.shared.storage import get_table_service_client
                # Should not raise
            except ImportError:
...
class TestStackInspection:
    ...
    def test_stack_inspection_detects_workspace_caller(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            workspace_file.write_text("from engine.shared.storage import test")
