...
class TestAuthenticationFlow:
    ...
    async def test_function_key_authentication_success(
        ...
        with patch('shared.storage.get_organization_async', return_value=mock_org_entity):
            with patch('shared.storage.get_org_config_async', return_value=mock_config_entities):
