...
class TestCheckApiHealth:
    ...
    async def test_returns_healthy_check(self):
...
class TestCheckKeyVaultHealth:
    ...
    async def test_none_manager_returns_degraded(self):
        """Test health check when manager is None"""
        result_check, status = await check_keyvault_health(None)
    ...
    async def test_healthy_manager(self):
        ...
        result_check, status = await check_keyvault_health(mock_manager)
    ...
    async def test_degraded_manager(self):
    ...
    async def test_unhealthy_manager(self):
    ...
    async def test_exception_handling(self):
        ...
        mock_manager = MagicMock()
        mock_manager.health_check = AsyncMock(side_effect=Exception("Connection timeout"))
    ...
    async def test_manager_without_vault_url(self):
...
class TestPerformGeneralHealthCheck:
    ...
    async def test_all_healthy(self):
        ...
        response = await perform_general_health_check(mock_manager)
    ...
    async def test_keyvault_degraded(self):
    ...
    async def test_keyvault_not_initialized(self):
        """Test general health check when Key Vault is not initialized"""
        response = await perform_general_health_check(None)
...
class TestPerformKeyVaultHealthCheck:
    ...
    async def test_manager_not_initialized(self):
        ...
        response = await perform_keyvault_health_check(None)
    ...
    async def test_healthy_keyvault(self):
        ...
        response = await perform_keyvault_health_check(mock_manager)
    ...
    async def test_degraded_keyvault(self):
    ...
    async def test_unhealthy_keyvault(self):
    ...
    async def test_exception_during_health_check(self):
        ...
        mock_manager = MagicMock()
        mock_manager.vault_url = "https://test-vault.vault.azure.net/"
        mock_manager.health_check = AsyncMock(side_effect=RuntimeError("Unexpected error"))
    ...
    async def test_missing_health_result_fields(self):
    ...
    async def test_manager_without_vault_url_attribute(self):
...
class TestIntegration:
    ...
    async def test_full_health_check_flow_healthy(self):
        ...
        # Test general health
        general_response = await perform_general_health_check(mock_manager)
        assert general_response.status == "healthy"

        # Test specific health
        specific_response = await perform_keyvault_health_check(mock_manager)
        assert specific_response.status == "healthy"

    async def test_full_health_check_flow_degraded(self):
