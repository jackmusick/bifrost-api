...
class TestGetRolesForUser:
    ...
    async def test_returns_platform_admin_roles(self, mock_provision):
        ...
        response = await get_roles_for_user("admin@example.com")
    ...
    @pytest.mark.asyncio
    @patch("shared.handlers.roles_source_handlers.ensure_user_provisioned")
    async def test_returns_org_user_roles(self, mock_provision):
        ...
        response = await get_roles_for_user("user@org.com")
    ...
    @pytest.mark.asyncio
    @patch("shared.handlers.roles_source_handlers.ensure_user_provisioned")
    async def test_raises_on_provisioning_failure(self, mock_provision):
        ...
        with pytest.raises(ValueError) as exc_info:
            await get_roles_for_user("unknown@nomatch.com")
    ...
    @pytest.mark.asyncio
    @patch("shared.handlers.roles_source_handlers.ensure_user_provisioned")
    async def test_new_user_created_as_admin(self, mock_provision):
        ...
        response = await get_roles_for_user("firstuser@example.com")
    ...
    @pytest.mark.asyncio
    @patch("shared.handlers.roles_source_handlers.ensure_user_provisioned")
    async def test_new_user_created_as_org_user(self, mock_provision):
        ...
        response = await get_roles_for_user("newuser@existing-org.com")
...
class TestHandleRolesSourceRequest:
    ...
    async def test_valid_request_with_both_fields(self, mock_get_roles):
    ...
    @pytest.mark.asyncio
    @patch("shared.handlers.roles_source_handlers.get_roles_for_user")
    async def test_missing_userId_still_provisions_user(self, mock_get_roles):
    ...
    @pytest.mark.asyncio
    async def test_missing_userDetails_returns_anonymous(self):
    ...
    @pytest.mark.asyncio
    async def test_missing_both_fields_returns_anonymous(self):
    ...
    @pytest.mark.asyncio
    async def test_empty_request_returns_anonymous(self):
    ...
    @pytest.mark.asyncio
    @patch("shared.handlers.roles_source_handlers.get_roles_for_user")
    async def test_provisioning_failure_raises_error(self, mock_get_roles):
        ...
        with pytest.raises(ValueError) as exc_info:
            await handle_roles_source_request(request_body)

        assert "No domain match" in str(exc_info.value)

    @pytest.mark.asyncio
    @patch("shared.handlers.roles_source_handlers.get_roles_for_user")
    async def test_different_identity_providers(self, mock_get_roles):
    ...
    @pytest.mark.asyncio
    @patch("shared.handlers.roles_source_handlers.get_roles_for_user")
    async def test_multiple_roles_returned(self, mock_get_roles):
...
class TestResponseStructure:
    ...
    @pytest.mark.asyncio
    async def test_response_has_roles_key(self):
    ...
    @pytest.mark.asyncio
    async def test_roles_are_strings(self):
    ...
    @pytest.mark.asyncio
    @patch("shared.handlers.roles_source_handlers.get_roles_for_user")
    async def test_response_format_matches_swa_expectation(self, mock_get_roles):
