#!/bin/bash
# Bifrost API - Test Runner for New Docker Stack
# Usage: ./test-new.sh [pytest args...]
#
# This script starts the new PostgreSQL/RabbitMQ/Redis stack,
...
# =============================================================================
echo "============================================================"
echo "Bifrost API - Test Runner (New Stack)"
echo "============================================================"
echo ""
