...
def get_table_storage_service(table_name: str = "Organizations") -> TableStorageService:
    """
    Get or create a TableStorageService instance (cached)

    Args:
        table_name: Table name to access

    Returns:
        TableStorageService instance
    """
...
def get_organization(org_id: str) -> Optional[dict]:
    ...
    """
    storage = get_table_storage_service("Organizations")
    return storage.get_entity(partition_key="ORG", row_key=org_id)
