...
export function FieldConfigDialog({ field, open, onClose, onSave, defaultType, workflowInputData, isWorkflowInput }: FieldConfigDialogProps) {
  ...
  // Fetch data providers from metadata
  const { data: metadata, isLoading: isLoadingMetadata } = useWorkflowsMetadata()
                ...
                >
                  <SelectTrigger id="dataProvider">
                    <SelectValue placeholder={
                      isLoadingMetadata ? 'Loading providers...' : 'Select a data provider...'
                    } />
                  </SelectTrigger>
                  <SelectContent>
                    ...
                    {isLoadingMetadata ? (
                      ...
                      dataProviders.map((provider) => (
                        <SelectItem key={provider.name ?? 'unknown'} value={provider.name ?? ''}>
                          <div className="flex flex-col">
                            <span className="font-mono text-sm">{provider.name ?? 'Unknown'}</span>
