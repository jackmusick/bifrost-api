...
it("exposes mixed selection, hidden selections, explicit sort choices and focused search recovery", async () => {
	...
	const props = { search: "Invoice", onSearch: vi.fn(), allSelected: false, someSelected: true, onSelectAll: vi.fn(), visibleCount: 2, selectedCount: 3, hiddenSelectedCount: 2, onClearSelection: vi.fn(), onDelete: vi.fn(), busy: false, busyMessage: "Updating…", sortBy: "name" as const, onSortBy: vi.fn(), ascending: true, onToggleDirection: vi.fn() };
