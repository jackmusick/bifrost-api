                ...
                <Card>
                    ...
                    <CardContent>
                        {isLoading ? (
                            ...
                            <div className="text-2xl font-bold">
                                {metrics?.executionStats.successRate?.toFixed(
                                    1
                                ) ?? 0}
                                %
                            </div>
                ...
                <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <Badge
                                variant={
                                    metrics?.executionStats.failedCount === 0
                                        ? "outline"
                                        : "destructive"
                                }
                            >
                                {isLoading
                                    ? "..."
                                    : metrics?.executionStats.failedCount ??
                                      0}{" "}
                                Failed
                            </Badge>
                            <Badge variant="default" className="bg-green-500">
                                {isLoading
                                    ? "..."
                                    : metrics?.executionStats.successCount ??
                                      0}{" "}
                                Success
                            </Badge>
                        </div>
