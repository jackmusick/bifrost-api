...
export interface paths {
    ...
    "/api/branding": {
         ...
         * @description Get global branding settings. Public endpoint for display.
         */
        get: operations["get_branding_endpoint_api_branding_get"];
        /**
         * Update branding settings
         * @description Update global branding settings (superuser only)
         */
        put: operations["update_branding_endpoint_api_branding_put"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/branding/logo/{logo_type}": {
        ...
        /**
         * Get logo image
         * @description Serve the logo image from database (square or rectangle)
         */
        get: operations["get_logo_api_branding_logo__logo_type__get"];
        put?: never;
        /**
         * Upload logo
         * @description Upload a logo (superuser only)
         */
        post: operations["upload_logo_typed_api_branding_logo__logo_type__post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/logs": {
        ...
        /**
         * List system logs
         * @description List system logs from PostgreSQL
         */
    ...
    "/api/logs/{category}/{log_id}": {
        ...
        /**
         * Get single log
         * @description Get a single system log entry by category and ID
         */
        get: operations["get_log_by_category_api_logs__category___log_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /** Body_upload_logo_typed_api_branding_logo__logo_type__post */
        Body_upload_logo_typed_api_branding_logo__logo_type__post: {
            /**
             * File
             * Format: binary
        ...
        CreateOAuthConnectionRequest: {
            ...
            /**
             * Client Secret
             * @description OAuth client secret (optional for PKCE flow, required for client_credentials, will be stored securely)
             */
            client_secret?: string | null;
            /**
             * Authorization Url
...
export interface operations {
    ...
    get_branding_endpoint_api_branding_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    update_branding_endpoint_api_branding_put: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    upload_logo_typed_api_branding_logo__logo_type__post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "multipart/form-data": components["schemas"]["Body_upload_logo_typed_api_branding_logo__logo_type__post"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    get_log_by_category_api_logs__category___log_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
