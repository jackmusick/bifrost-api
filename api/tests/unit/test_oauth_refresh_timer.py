...
from functions.oauth_refresh_timer import oauth_refresh_timer
...
class TestOAuthRefreshTimerTrigger:
    ...
    async def test_timer_function_executes(self, mock_timer_request):
        ...
        with patch('functions.oauth_refresh_timer.OAuthStorageService') as mock_storage, \
             patch('functions.oauth_refresh_timer.OAuthProviderClient') as mock_provider, \
             patch('functions.oauth_refresh_timer.TableStorageService') as mock_config, \
             patch('functions.oauth_refresh_timer.KeyVaultClient') as mock_keyvault:
