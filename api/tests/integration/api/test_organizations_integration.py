...
class TestOrganizationsIntegration:
    ...
    @pytest.mark.asyncio
    async def test_list_organizations_as_platform_admin(self):
        ...
        assert len(body) >= 2  # At least Covi Development and Contoso Ltd from seed data

        # Verify structure
        org_names = [org["name"] for org in body]
        assert "Covi Development" in org_names
        assert "Contoso Ltd" in org_names

    @pytest.mark.asyncio
    async def test_list_organizations_as_org_user_forbidden(self):
    ...
    async def test_create_organization_as_platform_admin(self):
        ...
        assert "tenantId" in body  # Auto-generated by API
        assert body["tenantId"] is not None  # Should have a value
    ...
    @pytest.mark.asyncio
    async def test_create_organization_as_org_user_forbidden(self):
